...
module.exports = function Executor(opts) {
     ...
     *   to state.$principal. The result of opts.authority(guest) will then
     ...
     *   Note: This is required if using opts.authority
     *
     *
     *
     *
    ...
    opts.authority = opts.authority || false;
