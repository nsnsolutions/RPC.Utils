...
var FilterHelper = function FilterHelperConstructor(opts) {
    ...
    function addIndexFilter(field, values) {
        opts.KeyConditionExpression += ' AND #' + field + ' = :' + field;
        opts.ExpressionAttributeNames['#' + field] = field;
        opts.ExpressionAttributeValues[':' + field] = values;
    }
